...
var ASM_CONSTS = {
  91054: () => { if (document.fullscreenElement) return 1; },  
 91100: () => { return Module.canvas.width; },  
 91132: () => { return parseInt(Module.canvas.style.width); },  
 91180: () => { document.exitFullscreen(); },  
 91207: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 91279: () => { if (document.fullscreenElement) return 1; },  
 91325: () => { return Module.canvas.width; },  
 91357: () => { return screen.width; },  
 91382: () => { document.exitFullscreen(); },  
 91409: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 91603: () => { return window.innerWidth; },  
 91629: () => { return window.innerHeight; },  
 91656: () => { if (document.fullscreenElement) return 1; },  
 91702: () => { return Module.canvas.width; },  
 91734: () => { return parseInt(Module.canvas.style.width); },  
 91782: () => { if (document.fullscreenElement) return 1; },  
 91828: () => { return Module.canvas.width; },  
 91860: () => { return screen.width; },  
 91885: () => { return window.innerWidth; },  
 91911: () => { return window.innerHeight; },  
 91938: () => { if (document.fullscreenElement) return 1; },  
 91984: () => { return Module.canvas.width; },  
 92016: () => { return screen.width; },  
 92041: () => { document.exitFullscreen(); },  
 92068: () => { if (document.fullscreenElement) return 1; },  
 92114: () => { return Module.canvas.width; },  
 92146: () => { return parseInt(Module.canvas.style.width); },  
 92194: () => { document.exitFullscreen(); },  
 92221: ($0) => { Module.canvas.style.opacity = $0; },  
 92259: () => { return screen.width; },  
 92284: () => { return screen.height; },  
 92310: () => { return window.screenX; },  
 92337: () => { return window.screenY; },  
 92364: () => { return window.devicePixelRatio; },  
 92400: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 92453: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 92504: () => { Module.canvas.style.cursor = 'none'; },  
 92541: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 92797: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 92848: () => { if (document.pointerLockElement) return 1; },  
 92895: () => { if (document.fullscreenElement) return 1; },  
 92941: () => { return window.innerWidth; },  
 92967: () => { return window.innerHeight; }
};
